CLASS zcl_agency_get DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_AGENCY_GET IMPLEMENTATION.
...
DATA:
      lt_business_data TYPE TABLE OF zud_sc_agency=>tys_z_travel_agency_es_5_type,
